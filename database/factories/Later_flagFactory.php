...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Later_flag>
 */
class Later_flagFactory extends Factory
{
    /**
    ...
    {
        $user_id = Later_flagFactory::random_user_id();
        $question_id = Later_flagFactory::random_question_id();
        
        while(Later_flagFactory::check($user_id, $question_id)){
            $user_id = Later_flagFactory::random_user_id();
            $question_id = Later_flagFactory::random_question_id();
        }
