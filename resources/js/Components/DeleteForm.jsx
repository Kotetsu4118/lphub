...
export default function DeleteForm({onDengerButton, showModal, onClose, onSubmit, text_id, input_value, label_value, processing, handleChange, errors, closeModal}){
    return(
        <div>
